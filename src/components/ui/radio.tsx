...
const radioVariants = cva(
  cn(
    "group border-gray-500 text-gray-900 aspect-square rounded-full border outline-none",
    "data-[state=checked]:border-gray-900",
    "disabled:border-gray-200 disabled:bg-gray-100",
    "data-[state=checked]:disabled:border-gray-200 data-[state=checked]:disabled:text-gray-200"
  ),
  {
    variants: {
      size: {
