        ...
        const content = isNode ? (
          ...
          <img
            className={cx(
              ...
              "motion-reduce:transition-none",
              scaleOnHover &&
                "transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/item:scale-120 cursor-pointer"
            )}
            src={item.src}
            srcSet={item.srcSet}
            sizes={item.sizes}
        ...
        const inner = item.href ? (
          <a
            className={cx(
              ...
              "transition-opacity duration-200 ease-linear cursor-pointer",
              "hover:opacity-80",
